<template>
  <div id='app'>
    ...
    <section-component>
      ...
      <h5>A &lt;router-link&gt; controls which route should show with the <code>to</code> attribute. The &lt;router-view&gt; displays the selected route.</h5>
...
@Component({
  components: {Watcher, ReverseText, FontSize, Clicker, SectionComponent, CodeSnippet, HelloWorld}
})
